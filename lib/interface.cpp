...
void GUI::show()
{
    ...
    else if (display.state == 3)
    {
        ...
        cout << " \033[7;37m     \033[0m" << endl
             ...
             << " \033[7;37mS " << map.warehouse[1] << " \033[7;37m  \033[0m  \033[7;34m " << map.pos[29] << "   " << map.pos[30] << "   " << map.pos[31] << "    " << map.pos[32] << "    " << map.pos[33] << "    " << map.pos[34] << "    " << map.pos[35] << "    " << map.pos[36] << "    " << map.pos[37] << "     " << map.pos[38] << "   " << map.pos[39] << "   " << map.pos[40] << "    \033[0m" << endl
